...
SUPABASE_SERVICE_KEY=your-service-key-here  # Service role key (secret, server-side only)
SUPABASE_ANON_KEY=your-anon-key-here  # Anonymous key (public, can be used in frontend)
