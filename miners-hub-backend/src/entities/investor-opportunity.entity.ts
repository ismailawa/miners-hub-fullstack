...
export class InvestorOpportunity {
  ...
  @Column({ name: 'capital_required', type: 'decimal', precision: 14, scale: 2, nullable: true })
  @IsOptional()
  @IsNumber()
  @Min(0)
  ...
  @Column({ type: 'enum', enum: InvestorOpportunityStage, default: InvestorOpportunityStage.DEVELOPMENT })
  @IsEnum(InvestorOpportunityStage)
  stage!: InvestorOpportunityStage;

  @Column({ name: 'risk_rating', type: 'enum', enum: InvestorOpportunityRiskRating, default: InvestorOpportunityRiskRating.MEDIUM })
  ...
  @Column({ type: 'enum', enum: InvestorOpportunityStatus, default: InvestorOpportunityStatus.DRAFT })
