...
export class AddInvestorOpportunities1782063400000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`CREATE TYPE "investor_opportunities_stage_enum" AS ENUM('exploration', 'development', 'production', 'expansion')`);
    await queryRunner.query(`CREATE TYPE "investor_opportunities_risk_rating_enum" AS ENUM('low', 'medium', 'high', 'critical')`);
    await queryRunner.query(`CREATE TYPE "investor_opportunities_status_enum" AS ENUM('draft', 'published', 'closed', 'archived')`);
    await queryRunner.query(`CREATE TYPE "investor_opportunity_inquiries_status_enum" AS ENUM('new', 'contacted', 'due_diligence', 'closed')`);
    ...
    `);
    await queryRunner.query(`CREATE INDEX "IDX_investor_opportunities_site_id" ON "investor_opportunities" ("site_id")`);
    await queryRunner.query(`CREATE INDEX "IDX_investor_opportunities_sponsor_id" ON "investor_opportunities" ("sponsor_id")`);
    await queryRunner.query(`CREATE INDEX "IDX_investor_opportunities_status" ON "investor_opportunities" ("status")`);
    await queryRunner.query(`CREATE INDEX "IDX_investor_opportunities_stage" ON "investor_opportunities" ("stage")`);
    await queryRunner.query(`CREATE INDEX "IDX_investor_opportunities_risk_rating" ON "investor_opportunities" ("risk_rating")`);
    await queryRunner.query(`ALTER TABLE "investor_opportunities" ADD CONSTRAINT "FK_investor_opportunities_site" FOREIGN KEY ("site_id") REFERENCES "mine_sites"("id") ON DELETE SET NULL`);
    await queryRunner.query(`ALTER TABLE "investor_opportunities" ADD CONSTRAINT "FK_investor_opportunities_sponsor" FOREIGN KEY ("sponsor_id") REFERENCES "users"("id") ON DELETE CASCADE`);
    await queryRunner.query(`
      CREATE TABLE "investor_opportunity_inquiries" (
        "id" uuid NOT NULL DEFAULT uuid_generate_v4(),
    ...
    `);
    await queryRunner.query(`CREATE INDEX "IDX_investor_opportunity_inquiries_opportunity_id" ON "investor_opportunity_inquiries" ("opportunity_id")`);
    await queryRunner.query(`CREATE INDEX "IDX_investor_opportunity_inquiries_investor_id" ON "investor_opportunity_inquiries" ("investor_id")`);
    await queryRunner.query(`CREATE INDEX "IDX_investor_opportunity_inquiries_status" ON "investor_opportunity_inquiries" ("status")`);
    await queryRunner.query(`ALTER TABLE "investor_opportunity_inquiries" ADD CONSTRAINT "FK_investor_opportunity_inquiries_opportunity" FOREIGN KEY ("opportunity_id") REFERENCES "investor_opportunities"("id") ON DELETE CASCADE`);
    await queryRunner.query(`ALTER TABLE "investor_opportunity_inquiries" ADD CONSTRAINT "FK_investor_opportunity_inquiries_investor" FOREIGN KEY ("investor_id") REFERENCES "users"("id") ON DELETE CASCADE`);
  }
