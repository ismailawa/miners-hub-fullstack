...
const RegisterPage: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            addNotification({
                ...
                message: 'Your account has been created. Please complete the onboarding steps.'
            });
    ...
    return (
        <div className="min-h-screen bg-primary text-text-secondary flex">
            {/* Left Column */}
            <div className="hidden lg:flex w-1/2 bg-cover bg-center relative items-center justify-center p-12" style={{ backgroundImage: `url('https://picsum.photos/seed/authpage2/1200/1800')` }}>
                <div className="absolute inset-0 bg-primary bg-opacity-70"></div>
                 <div className="relative z-10 text-center text-white">
                    ...
                    <p className="text-lg">
                        Connect with verified miners and investors on a secure, transparent platform.
                    </p>
                </div>
            </div>
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12">
                 <div className="w-full max-w-md">
                    ...
                    <p className="text-text-secondary mb-8">Join the premier digital marketplace for minerals.</p>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-text-muted" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" /></svg>
                                </div>
                                <input 
                                    id="name" 
                                    type="text" 
                    ...
                    <p className="text-center text-sm text-text-muted mt-6">
                        ...
                        <button onClick={() => setPage('login')} className="font-semibold text-accent hover:underline ml-1">
                            Sign In
                        </button>
                    </p>
                </div>
