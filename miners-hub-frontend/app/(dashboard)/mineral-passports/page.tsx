        ...
        <div className="space-y-6">
          {canIssue && (
            <section className="rounded-lg border border-border bg-secondary p-5">
              <h2 className="text-lg font-semibold text-text-primary">Issue Passport</h2>
        ...
        <section className="rounded-lg border border-border bg-secondary">
          <div className="flex flex-wrap items-center justify-between gap-3 border-b border-border p-5">
            <div>
              ...
              <p className="text-sm text-text-muted">{isLoading ? 'Loading passports...' : `${passports.length} passports shown`}</p>
            </div>
